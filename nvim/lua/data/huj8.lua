...
local special_ext_leader = ":"

local special_exts_leadered = {}

for k, v in pairs(special_exts) do
    special_exts_leadered[special_ext_leader .. k] = v
end

local specials = vim.tbl_extend("force", special_exts_leadered, {
    [" "] = "henkanFirst",
    ["^"] = "henkanPoint",
    ["<s-b>"] = "zenkaku",
    ["@"] = "katakana",
